          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                <div className="rounded-full  border border-[#66FCF1] p-2">
                  <Phone className="text-[#66FCF1]" size={20} />
                </div>
                <a
              ...
              <div className="flex items-center gap-3">
                <div className="rounded-full border border-[#66FCF1]  p-2">
                  <Mail className="text-[#66FCF1]" size={20} />
                </div>
                <a
            ...
            <div className="flex gap-4 items-center bg-[#03232B] px-4 rounded-md">
              <span className="text-[#66FCF1] text-[14px] md:text-[18px] lg:text-[20px] 2xl:text-[25px]  font-gotham italic  font-bold">
                Follow Us
              </span>
              <div className="flex gap-2">
                <div className="rounded-full border border-[#66FCF1] group  cursor-pointer  p-2">
                  <img
