        ...
        <main className='container 4xl:max-w-none mx-auto px-6 2xl:pt-20  pb-20 2xl:pb-24 text-center md:text-left'>
          <div className=''>
            ...
            <a
              ...
              className='inline-block cursor-pointer border-2 font-gotham border-[#35A070] text-[#66FCF1] px-8 py-3 rounded-lg hover:bg-[#66FCF1] hover:text-teal-950 transition duration-300 italic font-bold text-lg'
            >
              Discover Event Highlights
            </a>
          </div>
