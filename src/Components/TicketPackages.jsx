    ...
    <section className="w-full bg-[#101118] py-16"id="ticket">
      <div className="container 4xl:max-w-none mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-white/80 text-lg italic mt-4">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {packages.map((pkg, index) => (
            <div
              key={index}
              className="relative bg-[#03232B] gradient-border  rounded-tl-[25px]  rounded-br-[25px] min-w-[230px] min-h-[120px] p-4 pb-2 flex items-center justify-center shadow-md overflow-hidden"
            >
